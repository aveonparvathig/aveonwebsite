  ...
  return (
    <>
      ...
      <div className="mt-8 flex gap-4">
        <Link
          href="/"
          className="rounded-full bg-gradient-to-br from-primary-600 to-primary-700 hover:to-primary-600 px-7 py-3 text-sm font-semibold text-white hover:bg-primary-600"
        >
          Go Home
        </Link>
        <Link
