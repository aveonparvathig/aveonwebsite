    ...
    <section className="relative py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-[1320px] px-4 sm:px-6 lg:px-10">
        ...
        <div className="mt-12 flex flex-col items-center gap-4 sm:mt-16">
          ...
          <Link
            href="/contact#demo"
            className="inline-flex items-center gap-2.5 rounded-full bg-gradient-to-br from-primary-600 to-primary-700 hover:to-primary-600 px-8 py-3.5 text-[15px] font-bold text-white shadow-[0_18px_40px_-14px_rgb(29_111_242_/_0.85)] transition-all hover:-translate-y-0.5 hover:bg-primary-600"
          >
            Book a Consultation
