...
const products = [
  { title: "University ERP", slug: "university-erp", category: "erp", tagline: "Education ERP", order: 1,
    description: "End-to-end ERP for universities — academics, admissions, accounts, examinations, and departmental analytics in one integrated platform.",
  ...
  { title: "HRM & Payroll", slug: "hrm-payroll", category: "management", tagline: "HR Management", order: 5,
    description: "Human resource management and payroll processing built for educational institutions — from recruitment to retirement.",
